...
namespace Tanks.Complete
{
    public class TankShooting : MonoBehaviour
    {
        ...
        // 📢 NUEVA VARIABLE: El GameObject de tu flecha/indicador (que contiene el Sprite).
        public GameObject m_ArrowIndicator;
        ...
        private void OnEnable()
        {
            ...
            // 📢 Asegurar que el indicador de flecha esté DESACTIVADO al inicio
        ...
        void HumanUpdate()
        {
            ...
            if (m_ShotCooldownTimer > 0.0f)
            {
                ...
                // 📢 OCULTAR la flecha durante el cooldown
                if (m_ArrowIndicator != null) m_ArrowIndicator.SetActive(false);
            }
            ...
            if (m_CurrentLaunchForce >= m_MaxLaunchForce && !m_Fired)
            {
                ...
                // 📢 OCULTAR la flecha después del disparo automático
                if (m_ArrowIndicator != null) m_ArrowIndicator.SetActive(false);
            }
            ...
            else if (m_ShotCooldownTimer <= 0 && fireAction.WasPressedThisFrame())
            {
                ...
                // 📢 MOSTRAR LA FLECHA (¡Aparece justo al inicio de la carga!)
                if (m_ArrowIndicator != null) m_ArrowIndicator.SetActive(true);
            }
            // Otherwise, if the fire button is being held and the shell hasn't been launched yet...
            else if (fireAction.IsPressed() && !m_Fired)
            {
                ...
                m_AimSlider.value = m_CurrentLaunchForce;
                // La flecha permanece visible mientras se carga
            }
            // Otherwise, if the fire button is released and the shell hasn't been launched yet...
            else if (fireAction.WasReleasedThisFrame() && !m_Fired)
            {
                ...
                // 📢 OCULTAR LA FLECHA al disparar
                if (m_ArrowIndicator != null) m_ArrowIndicator.SetActive(false);
            }

            // 📢 SEGURIDAD: OCULTAR la flecha si por alguna razón sigue activa sin cargarse
            else if (!fireAction.IsPressed() && !m_Fired && m_ArrowIndicator != null && m_ArrowIndicator.activeSelf)
            {
                m_ArrowIndicator.SetActive(false);
            }
        }
        ...
        private void Fire()
        {
            ...
            // 📢 OCULTAR la flecha (En caso de que Fire fuera llamado por AI o auto-disparo)
            if (m_ArrowIndicator != null) m_ArrowIndicator.SetActive(false);
